...
public class Tpa implements CommandExecutor {
    ...
    public Tpa(FallCraftSystem plugin) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        Utilities.getTpa().put(player2, player);
        ...
        player2.sendMessage(Ultilities.formater(ServerUtils.SERVER_NAME + "&6O &c" + player.getName() + "&6 pediu para teletransportar para você."));
